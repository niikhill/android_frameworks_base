...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    public boolean onLongClick(View v) {
        if (v == mSettingsButton) {
            startSereinExtrasActivity();
            mVibrator.vibrate(50);
        }
        return false;
    }
     private ComponentName SEREIN_EXTRAS_SETTING_COMPONENT = new ComponentName(
            "com.android.settings", "com.android.settings.Settings$SereinExtrasActivity");
     private void startSereinExtrasActivity() {
        mActivityStarter.startActivity(new Intent().setComponent(SEREIN_EXTRAS_SETTING_COMPONENT),
                true /* dismissShade */);
    }
